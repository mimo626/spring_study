...
public class UploadController2 {
	...
	public ModelAndView saveFile(FileVO2 vo) {
	     ...
	     String resultStr = "";
	     String path = "/Users/kangminju/Desktop/아이티센 AIE 교육/0424/uploadtest/multi";
	     ...
	     for (MultipartFile mfile : vo.getUploadFiles()) {
				...
				try {
					File f = new File("/Users/kangminju/Desktop/아이티센 AIE 교육/0424/uploadtest/multi/" + fileName);
					if (f.exists()) {
